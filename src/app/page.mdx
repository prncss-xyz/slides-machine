...
<Flex gap="6" align="center" maxHeight="80vh" overflow="hidden">
	<Box maxHeight="80vh" overflow="scroll">
    ```tsx 
    !from ./samples/turnstile2/component.tsx 9:35
    ```
	</Box>
  <Flex gap="6" direction="column" align="start">
    <Card>
...
<Flex gap="6" align="center" maxHeight="80vh" overflow="hidden">
	<Box maxHeight="80vh" overflow="scroll">
    ```tsx 
    !from ./samples/turnstile2/component.tsx 37:60
    ```
	</Box>
  <Flex gap="6" direction="column" align="start">
    <Card>
...
<Flex gap="6" align="center" maxHeight="80vh" overflow="hidden">
	<Box maxHeight="80vh" overflow="scroll">
    ```tsx 
    !from ./samples/turnstile2/component.tsx 83:114
    ```
	</Box>
  <Flex gap="6" direction="column" align="start">
    <Card>
...
<Flex gap="6" align="center" maxHeight="80vh" overflow="hidden">
	<Box maxHeight="80vh" overflow="scroll">
    ```tsx 
    !from ./samples/turnstile2/component.tsx 62:81
    ```
	</Box>
  <Flex gap="6" direction="column" align="start">
    <Card>
